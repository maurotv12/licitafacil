            ...
            <tr>
                <th scope="col" class="px-6 py-3">
                    <div class="flex items-center">
                        No identificacion
                        <a href="#" wire:click="ordenar('no_identificacion')">
                ...
                <th scope="col" class="px-6 py-3">
                    <div class="flex items-center">
                        Correo
                        <a href="#" wire:click="ordenar('email')">
                            <svg class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z"/>
                            </svg>
                        </a>
        ...
        <tbody>
            @foreach ($clientes as $cliente)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" wire:click="abrirModalEditar({{$cliente->id}})">Editar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form class="max-w-2xl mx-auto" autocomplete="off" @submit.prevent="submit">
                        <div class="grid grid-cols-2 gap-2 mt-2">
                            <div class="mb-5">
                                <label for="no_identificacion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Numero identificación</label>
                                <input wire:model="no_identificacion" type="text" id="no_identificacion" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="1234567" required />
                                <x-input-error :messages="$errors->get('no_identificacion')" class="mt-2" />
                            </div>
                            <div class="mb-5">
